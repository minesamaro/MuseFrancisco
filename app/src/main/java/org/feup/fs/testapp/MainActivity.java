...
public class MainActivity extends Activity implements OnClickListener {
    ...
    private static final int REQUEST_BLUETOOTH_PERMISSIONS = 1; // I CHANGED THIS
    ...
    private void updateEeg() {
        ...
        tp9.setText(String.format(Locale.getDefault(), "%6.4f", eegBuffer[0]));
        fp1.setText(String.format(Locale.getDefault(), "%6.4f", eegBuffer[1]));
        fp2.setText(String.format(Locale.getDefault(), "%6.4f", eegBuffer[2]));
        tp10.setText(String.format(Locale.getDefault(), "%6.4f", eegBuffer[3]));
    }

    private void updateAlpha() {
        TextView elem1 = findViewById(R.id.elem1);
        elem1.setText(String.format(Locale.getDefault(), "%6.4f", alphaBuffer[0]));
        TextView elem2 = findViewById(R.id.elem2);
        elem2.setText(String.format(Locale.getDefault(), "%6.4f", alphaBuffer[1]));
        TextView elem3 = findViewById(R.id.elem3);
        elem3.setText(String.format(Locale.getDefault(), "%6.4f", alphaBuffer[2]));
        TextView elem4 = findViewById(R.id.elem4);
        elem4.setText(String.format(Locale.getDefault(), "%6.4f", alphaBuffer[3]));
    }
    private void updateBeta() {
        TextView elem1 = findViewById(R.id.beta1);
        elem1.setText(String.format(Locale.getDefault(), "%6.4f", betaBuffer[0]));
        TextView elem2 = findViewById(R.id.beta2);
        elem2.setText(String.format(Locale.getDefault(), "%6.4f", betaBuffer[1]));
        TextView elem3 = findViewById(R.id.beta3);
        elem3.setText(String.format(Locale.getDefault(), "%6.4f", betaBuffer[2]));
        TextView elem4 = findViewById(R.id.beta4);
        elem4.setText(String.format(Locale.getDefault(), "%6.4f", betaBuffer[3]));
    }
